...
export const UNIVERSE_CHAIN_INFO: ChainInfo = {
  ...
  [UniverseChainId.Sepolia]: {
    ...
    stablecoins: [USDC_SEPOLIA, USDT_SEPOLIA],
    statusPage: undefined,
    supportsClientSideRouting: true,
  ...
  [UniverseChainId.ArbitrumSepolia]: {
    ...
    sdkId: UniswapSDKChainId.ARBITRUM_SEPOLIA,
    assetRepoNetworkName: undefined,
    backendChain: {
      chain: BackendChainId.Arbitrum as InterfaceGqlChain,
      isSecondaryChain: true,
    ...
    chainPriority: 1,
    docs: 'https://offchainlabs.com/',
    elementName: ElementName.ChainArbitrumSepolia,
    explorer: {
      name: 'Arbiscan',
    ...
    rpcUrls: {
      ...
      appOnly: { http: ['https://sepolia-rollup.arbitrum.io/rpc'] },
    },
  ...
  [UniverseChainId.Base_Sepolia]: {
    ...baseSepolia,
    id: UniverseChainId.Base_Sepolia,
  ...
  [UniverseChainId.Avalanche_Fuji]: {
    ...avalancheFuji,
    id: UniverseChainId.Avalanche_Fuji,
    sdkId: UniswapSDKChainId.AVALANCHE_FUJI,
    assetRepoNetworkName: undefined,
    backendChain: {
      chain: BackendChainId.Avalanche as InterfaceGqlChain,
      backendSupported: true,
    ...
    chainPriority: 6,
    docs: 'https://docs.avax.network/',
    elementName: ElementName.ChainAvalancheFuji,
    explorer: {
      name: 'Snowtrace',
    ...
    pendingTransactionsRetryOptions: undefined,
    rpcUrls: {
      [RPCType.Public]: { http: ['https://api.avax-test.network/ext/bc/C/rpc'] },
      default: { http: ['https://api.avax-test.network/ext/bc/C/rpc'] },
      appOnly: { http: ['https://api.avax-test.network/ext/bc/C/rpc'] },
    },
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_AVAX_FUJI, 10_000e6),
    stablecoins: [USDC_AVAX_FUJI],
    statusPage: undefined,
    supportsClientSideRouting: true,
    supportsGasEstimates: false,
    urlParam: 'avalanche_fuji',
    wrappedNativeCurrency: {
      name: 'Wrapped AVAX',
      symbol: 'WAVAX',
      decimals: 18,
  ...
  [UniverseChainId.JocTestnet]: {
    ...jocTestnet,
    id: UniverseChainId.JocTestnet,
    sdkId: UniswapSDKChainId.JOC_TESTNET,
    assetRepoNetworkName: undefined,
    backendChain: {
    ...
    chainPriority: 0,
    docs: '',
    elementName: ElementName.ChainJocTestnet,
    explorer: {
    ...
    logo: JOC_TESTNET_LOGO,
    nativeCurrency: {
      name: 'JOCT Coin Testnet',
      symbol: 'JOCT',
      decimals: 18,
      address: DEFAULT_NATIVE_ADDRESS,
    },
    ...
    wrappedNativeCurrency: {
      ...
      symbol: 'WJOCT',
      decimals: 18,
      address: '0x8B85219c0767Ce4FA5ae5944d71aB4a3De27090d',
    },
  } as const satisfies UniverseChainInfo,
  [UniverseChainId.JocMainnet]: {
    ...jocMainnet,
    id: UniverseChainId.JocMainnet,
    sdkId: UniswapSDKChainId.JOC_MAINNET,
    assetRepoNetworkName: undefined,
    backendChain: {
      chain: BackendChainId.UnknownChain as InterfaceGqlChain,
      backendSupported: false,
    ...
    chainPriority: 0,
    docs: '',
    elementName: ElementName.ChainJocMainnet,
    explorer: {
      name: 'Block Explorer',
    ...
    rpcUrls: {
      [RPCType.Public]: { http: ['https://rpc-1.japanopenchain.org:8545'] },
      default: { http: ['https://rpc-1.japanopenchain.org:8545'] },
      appOnly: { http: ['https://rpc-1.japanopenchain.org:8545'] },
    },
    urlParam: 'joc',
    statusPage: undefined,
    spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDTX_JOC_MAINNET, 10_000e6),
    stablecoins: [USDTX_JOC_MAINNET, USDCX_JOC_MAINNET],
    supportsClientSideRouting: true,
    supportsGasEstimates: false,
    wrappedNativeCurrency: {
      name: 'Wrapped JOC',
      symbol: 'WJOC',
      decimals: 18,
      address: '0x03527b82f384184097295fc60be0B59B8FE06E00',
    },
  } as const satisfies UniverseChainInfo,
}
