...
export const UNIVERSE_CHAIN_INFO: ChainInfo = {
  ...
  [UniverseChainId.JocMainnet]: {
    ...
    rpcUrls: {
      [RPCType.Public]: { http: ['https://rpc-3.japanopenchain.org'] },
      default: { http: ['https://rpc-3.japanopenchain.org'] },
      appOnly: { http: ['https://rpc-3.japanopenchain.org'] },
    },
    urlParam: 'jocMainnet',
    statusPage: undefined,
